...
st.write("Predict house price using Random Forest Regressor")
...
square_feet = st.number_input("Square Feet", min_value=200, max_value=10000, value=1500)
...
distance = st.number_input("Distance to City (km)", min_value=0.0, max_value=100.0, value=10.0)
